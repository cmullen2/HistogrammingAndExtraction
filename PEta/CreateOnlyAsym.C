...
void CreateOnlyAsym() {
  ...
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/PEta/Coplan/BinsFixedCutsSameAsConfigBins.root");

  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/PEta/Coplan/AsymsBinsProtonChannel.root","recreate");
