...
void CreateOneBinOnlyAsym() {
  ...
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/AllNoBinsFixedCutsSameAsConfigBins2.root");
  //TFile *infile = TFile::Open("/w/work1/home/chris/TestingFinalNoPolNoW995.root");

  TFile *outfile =new TFile("/w/work1/home/chris/AsymsAllNoBins.root","recreate");
