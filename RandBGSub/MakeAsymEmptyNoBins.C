...
//  TFile *infile = TFile::Open("/w/work1/home/chris/TestingFinalNoPolNewPhi20bins.root");
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/RandBGMethod/EmptyBinnedBGSubbedProtonChannel2.root");
  //TFile *infile = TFile::Open("/w/work1/home/chris/TestingFinalNoPolNoW995.root");

  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/RandBGMethod/EmptyAsymBGSubbedProtonChannel.root","recreate");
...
cout << tbinKey->GetName() << endl;      
	...
	while ((polbinKey=(TKey*)nextPolbinDir())){   //Looping round my polarisation states - +
	  ...
	  while ((histKey=(TKey*)nextHist())) {
	    ...
	    if(IsPhi=="Phi" && IsPolPos=="PolStateD-0.50_"){
	      TString PolPosName ="/" + (TString)tbinDir->GetName()   + "/PolStateD0.50_/Phi";
	      TString PolarPosName ="/" + (TString)tbinDir->GetName() + "/PolStateD0.50_/Polarisation";
	      TString PolarNegName ="/" + (TString)tbinDir->GetName() + "/PolStateD-0.50_/Polarisation";
	 	...
	 	if(AvePol==0)AvePol=0.0000000001;
	      ...
	      string thetabin = (string)tbinDir->GetName() ;
	      //cout << thetabin << endl;
	      Double_t thetalen = thetabin.size();
	      string thetabin3 = thetabin.substr(11,thetalen -1 );
	      //cout << thetabin3 << endl;
	...
	TString Wbin = "AllCoplanarity";
//	TString Wbin = (TString)tbinDir->GetName();
//	TString Wname = "Sig" +  (TString)tbinDir->GetName();
	TString Wname = "SigAllCoplanarity";
	 //Closing tbin here now for jsut coplanarity
