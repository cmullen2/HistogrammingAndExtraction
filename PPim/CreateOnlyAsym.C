...
void CreateOnlyAsym() {
  ...
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/PPim/Coplan/BinsFixedCutsSameAsConfigBins.root");

  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/PPim/Coplan/AsymsBinsPPimChannel.root","recreate");
