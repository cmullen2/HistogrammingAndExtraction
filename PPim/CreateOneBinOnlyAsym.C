...
void CreateOneBinOnlyAsym() {
  ...
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/PPim/Coplan/AllNoBinsFixedCutsSameAsConfigBins.root");

  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/PPim/Coplan/AsymsAllNoBins.root","recreate");
