...
//  TFile *infile = TFile::Open("/w/work1/home/chris/TestingFinalNoPolNewPhi20bins.root");
  TFile *infile = TFile::Open("/w/work1/home/chris/HistoSelector/Neutron/CoplanPoly2ndOrder/BinsFixedCutsSameAsConfigBins2.root");
  //TFile *infile = TFile::Open("/w/work1/home/chris/TestingFinalNoPolNoW995.root");

  TFile *outfile =new TFile("/w/work1/home/chris/HistoSelector/Neutron/CoplanPoly2ndOrder/AsymsBinsNeutronChannel.root","recreate");
