...
void MakeHSSelector(TString treeName = "HSParticles"){
...
//	sk->SetFinalStateTopo("proton:gamma:gamma,neutron:gamma:gamma"); //add topology where all three particles are detected
